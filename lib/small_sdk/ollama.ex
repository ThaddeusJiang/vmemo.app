defmodule SmallSdk.Ollama do
  ...
  ## Example
      ...
      {:ok, "A llama standing in a field."}
  """
  def complete(%{
        model: model,
        prompt: prompt,
  ...
  def get_env() do
    url = Application.fetch_env!(:vmemo, :ollama_url) |> Utils.validate_url!()
    api_key = Application.fetch_env!(:vmemo, :ollama_api_key)
  ...
  defp handle_response({:error, reason}) do
    Logger.warning("Request failed: #{reason}")
    {:error, reason}
  end
